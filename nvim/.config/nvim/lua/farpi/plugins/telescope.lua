return {
  ...
  config = function()
    ...
    vim.keymap.set("n", "<leader>ft", "<cmd>lua require'telescope.builtin'.current_buffer_fuzzy_find{}<CR>",
    ...
    vim.keymap.set("n", "<leader>fg", "<cmd>lua require'telescope.builtin'.git_status{}<CR>",
