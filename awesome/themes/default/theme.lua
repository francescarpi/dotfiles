...
theme.layout_fairh = os.getenv("HOME") .. "/.dotfiles/awesome/themes/default/layouts/fairhw.png"
theme.layout_fairv = os.getenv("HOME") .. "/.dotfiles/awesome/themes/default/layouts/fairvw.png"
theme.layout_floating  = os.getenv("HOME") .. "/.dotfiles/awesome/themes/default/layouts/floatingw.png"
theme.layout_magnifier = os.getenv("HOME") .. "/.dotfiles/awesome/themes/default/layouts/magnifierw.png"
theme.layout_max = os.getenv("HOME") .. "/.dotfiles/awesome/themes/default/layouts/maxw.png"
theme.layout_fullscreen = os.getenv("HOME") .. "/.dotfiles/awesome/themes/default/layouts/fullscreenw.png"
theme.layout_tilebottom = os.getenv("HOME") .. "/.dotfiles/awesome/themes/default/layouts/tilebottomw.png"
theme.layout_tileleft   = os.getenv("HOME") .. "/.dotfiles/awesome/themes/default/layouts/tileleftw.png"
theme.layout_tile = os.getenv("HOME") .. "/.dotfiles/awesome/themes/default/layouts/tilew.png"
theme.layout_tiletop = os.getenv("HOME") .. "/.dotfiles/awesome/themes/default/layouts/tiletopw.png"
theme.layout_spiral  = os.getenv("HOME") .. "/.dotfiles/awesome/themes/default/layouts/spiralw.png"
theme.layout_dwindle = os.getenv("HOME") .. "/.dotfiles/awesome/themes/default/layouts/dwindlew.png"
